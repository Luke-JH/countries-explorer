<template>
  <fieldset>
    <legend class="text-xs font-semibold uppercase tracking-wide text-atlas-muted dark:text-atlas-muted-dark">
      Population
    </legend>
    <div class="mt-1.5 flex items-center gap-2">
      ...
      />
      <span class="text-sm text-atlas-muted dark:text-atlas-muted-dark" aria-hidden="true">to</span>

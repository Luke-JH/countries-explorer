<template>
    <div
        class="overflow-x-auto rounded-lg border border-atlas-border dark:border-atlas-border-dark"
    >
        <table class="w-full min-w-full border-collapse text-sm sm:min-w-[520px]">
            ...
            <thead>
                <tr
                    class="border-b border-atlas-border bg-atlas-raised/60 dark:border-atlas-border-dark dark:bg-atlas-raised-dark/60"
                >
                    <th
                        scope="col"
                        class="px-1 py-2.5 text-left font-semibold text-atlas-ink sm:px-4 dark:text-atlas-ink-dark"
                    >
                        Name
                    </th>
                    <th
                    ...
                    <th
                        scope="col"
                        class="px-1 py-2.5 text-right font-semibold text-atlas-ink sm:px-4 dark:text-atlas-ink-dark"
                    >
                        Population
                    </th>
            ...
            <tbody :aria-busy="loading">
                ...
                <template v-else-if="countries.length">
                    ...
                    >
                        ...
                        <td
                            class="px-1 py-2.5 text-right tabular-nums text-atlas-ink sm:px-4 dark:text-atlas-ink-dark"
                        >
                ...
                <tr v-else>
                    <td
                        colspan="5"
                        class="px-4 py-8 text-center text-atlas-muted dark:text-atlas-muted-dark"
                    >
